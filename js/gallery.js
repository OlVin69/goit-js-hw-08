...
function handleClick(event) {
    ...
    const targetImage = event.target.classList.contains('gallery-image') ? event.target : null;

    if (targetImage) {
        const largeImageSrc = targetImage.dataset.source;
        const modalImage = basicLightbox.create(`<img src="${largeImageSrc}" alt="${targetImage.alt}">`, {
